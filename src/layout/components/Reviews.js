                ...
                <div className="Reviews-container">
                    <div className="Reviews-col">
                        ...
                        <div className="Reviews-text-col">
                            <h1 className="Reviews-text-title">Hand Sanitizer</h1>
                            <hr className="Reviews-hr" />
                            <p className="Reviews-text-paragraph">“I always keep a bottle in my desk at the office for my colleagues to use. I would recommend it.”-Brianna S.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="Reviews-container">
                    <div className="Reviews-col">
                        ...
                        <div className="Reviews-text-col">
                            ...
                            <hr className="Reviews-hr" />
                            <p className="Reviews-text-paragraph">“Doing research on the ingredients I found this bleach to be one of the more effective ones to disinfect.”-Nelson V.</p>
                        </div>
                    </div>
                </div>
            </div> 
